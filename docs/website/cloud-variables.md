...
On Scratch you can connect to cloud variable server (except if your not connected or a new scratcher) example this scratch link https://scratch.mit.edu/projects/1189176388/
